        ...
        <Header
          ...
          leftClick1={() => {
            if (remarkShow) {
              ...
              // let backquery = tooler.getQueryString('backquery')
              // /*
              //   &backquery=a:1,b:1,c:1
              // */
              // if (backquery && backquery.indexOf(':') > 0) {
              //   this.props.match.history.push(urls.PUSHORDER + tooler.queryTourl(backquery))
              // } else {
              //   this.props.match.history.push(urls.PUSHORDER)
              // }
            ...
            // this.props.match.history.push(urls.PUSHORDER + '?settleId=' + settleId + '&&classifyId=' + classifyId + '&&classifyVal=' + classifyVal + (teachId ? ('&teachVal=' + teachVal + '&teachId=' + teachId) : ''))
          }}
