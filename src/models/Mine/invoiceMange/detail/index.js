        ...
        <Content>
          {
            !isLoading
              ? <div ref={(e) => { this.down = e }} className={style['detail-box']}>
                ...
                {
                  dataSource['user_type'] === 2 ? <Button style={{ display: dataSource['status'] === 11 || dataSource['status'] === 12 || dataSource['approval_status'] === 4 ? 'block' : 'none' }} className={`${style['cancel']} ${style['btn']}`} onClick={() =>
