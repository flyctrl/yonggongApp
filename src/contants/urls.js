...
export const INVOICENEWMANGE = `${MINE}/invoiceMange/index3` // 新发票管理
export const INVOICEORDER = `${INVOICEMANGE}/order` // 工单开票
export const TITLEMANGE = `${INVOICEMANGE}/title` // 抬头管理
export const TITLEOPERATE = `${TITLEMANGE}/operate` // 抬头添加和编辑
export const ADDRESSMANGE = `${INVOICEMANGE}/address` // 地址管理
export const ADDRESSOPERATE = `${ADDRESSMANGE}/operate` // 地址添加和编辑
export const INVOICENEWDETAIL = `${INVOICEMANGE}/detail/index` // 新发票详情
export const APPLYINEWINVOICE = `${MINE}/invoiceMange/applyInvoice/index2` // 申请新发票
